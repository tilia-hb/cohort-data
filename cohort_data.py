...
def sort_by_cohort(filename):
    ...
    for line in file:
    	...
    	elif person[-1] == "Summer 2016":
    		summer_16.append(name)
    		#all_students.append(name)

    	elif person[-1] == "Spring 2016":
    		spring_16.append(name)
    		#all_students.append(name)
    	elif person[-1] == "Winter 2016":
...
def all_students_tuple_list(filename):
    ...
    for line in file:
    	...
    	firstname,lastname,house,advisor,role = person
    	name = firstname + " " + lastname

    	if house != "":

	    	student_list.append((name,house,advisor,role))
